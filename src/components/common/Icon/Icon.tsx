...
const Icon: React.FC<IconProps> = ({ testId = "icon", name, width = 24, height = 21.68, onClick }) => {
  const getSvgIcon = () => {
    switch (name) {
      ...
      case IconName.MARVEL_LOGO:
        return (
          <svg
            ...
            data-testid={testId}
          >
            <g clipPath="url(#clip0_14854_731)">
  ...
  return onClick ? (
    <button className="buttonIcon" onClick={onClick} data-testid={`${testId}-button`}>
      {SvgIcon}
    </button>
  ) : (
    SvgIcon
